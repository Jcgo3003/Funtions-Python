...
for n in range (len(l_sen_a)):
    ...
    for i in range ( ini_a ,ron_a[2] +1 ):
        ...
        bd = c.fetchone()
        print('bd ', bd)
        lista_bd.append( bd[0] )
        print('i = ', i)
    print('lista_bd', lista_bd )

    # sacando promedio de la lista
    print()
    print("inicio llenado lista t")

    for y in range (len(lista_bd) -1):
        # Obteniendo la sustracion de t2 - t1 para cada valor en lista_bd
        tdel = datetime.strptime(lista_bd[y+1], FMT) - datetime.strptime(lista_bd[y], FMT)
    ...
    print('Lista borrada lista_bd', lista_bd)
    print()
...
#LIMITACIONES PARA HACER PROMEDIO PIDE AL MENOS DOS NUMEROS - HABRA ERRORES SI NO HAY AL MENOS 2 RODAS